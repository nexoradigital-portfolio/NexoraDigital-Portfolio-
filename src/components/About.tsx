...
export const About: React.FC<AboutProps> = ({ onOpenInquiry }) => {
  ...
  return (
    <section id="about" className="py-24 md:py-32 bg-[#050505] text-white relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 relative z-10">
        ...
        <div className="flex flex-col items-start max-w-3xl mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-extrabold tracking-tight text-white mb-6 leading-tight">
            More Than Code. <br className="hidden sm:inline" />
            <span className="text-[#A4C639]">I Build Digital Growth.</span>
          </h2>

          <p className="text-lg sm:text-xl text-[#F5F5F5] font-normal leading-relaxed mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
          ...
          <div className="lg:col-span-5 relative group">
            <div className="relative h-full min-h-[380px] rounded-2xl overflow-hidden border border-white/10 bg-[#111111] shadow-2xl">
              <img
              ...
              {/* Overlay Badge */}
              <div className="absolute bottom-6 left-6 right-6 p-4 rounded-xl bg-[#0B0B0B]/90 backdrop-blur-md border border-[#A4C639]/30">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {ABOUT_PILLARS.map((pillar, idx) => (
              <div
                key={pillar.title}
                className="p-6 rounded-2xl bg-[#111111] border border-white/10 hover:border-[#A4C639]/50 transition-all duration-300 group hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(164,198,57,0.1)] flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-10 h-10 rounded-xl bg-black border border-white/10 group-hover:border-[#A4C639]/40 flex items-center justify-center transition-colors">
                      {iconMap[pillar.icon]}
                    </div>
                  ...
                  <h3 className="text-lg font-display font-bold text-white group-hover:text-[#A4C639] transition-colors mb-1.5">
                    {pillar.title}
                  </h3>
                ...
                <div className="pt-4 mt-4 border-t border-white/5 flex items-center gap-1.5 text-xs text-[#9A9A9A] group-hover:text-white transition-colors">
