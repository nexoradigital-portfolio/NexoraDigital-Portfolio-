...
export const SelectedWork: React.FC<SelectedWorkProps> = ({ onSelectProject }) => {
  ...
  return (
    <section id="work" className="py-24 md:py-32 bg-white text-[#111111] relative overflow-hidden border-t border-black/5">
            ...
            >
              <div>
                ...
                <div className="relative aspect-[16/10] bg-[#050505] overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 px-2.5 py-1 rounded-full bg-black/80 backdrop-blur-md border border-[#A4C639]/40 text-[11px] font-mono font-bold text-[#A4C639]">
                    {project.number}
                  </div>
                ...
                <div className="p-6 sm:p-7">
                  ...
                  <h3 className="text-xl font-display font-extrabold text-[#111111] group-hover:text-[#607A16] transition-colors mb-2.5 line-clamp-1">
                    {project.title}
                  </h3>

                  <p className="text-xs sm:text-sm text-[#555555] line-clamp-2 leading-relaxed mb-5">
                    {project.description}
                  </p>

                  {/* Highlight Metric */}
                  <div className="p-3 rounded-xl bg-[#F5F5F5] border border-black/5 flex items-center justify-between mb-5">
