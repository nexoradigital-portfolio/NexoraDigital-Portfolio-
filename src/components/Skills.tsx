...
export const Skills: React.FC = () => {
  ...
  return (
    <section id="skills" className="py-24 md:py-32 bg-white text-[#111111] relative overflow-hidden border-t border-black/5">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          {(activeTab === "all" || activeTab === "web") && (
            <div className="p-8 sm:p-10 rounded-3xl bg-[#F5F5F5] border border-black/10 shadow-sm hover:shadow-md transition-shadow relative flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-2xl bg-black text-[#A4C639] flex items-center justify-center font-bold">
                      <Code className="w-6 h-6" />
                    </div>
                    <div>
                      <span className="text-[11px] font-bold text-[#607A16] uppercase tracking-widest">Discipline 01</span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {SKILLS_DATA.webDevelopment.skills.map((skill) => (
                    <div
                      key={skill.name}
                      className="p-3.5 rounded-xl bg-white border border-black/10 hover:border-[#607A16] hover:bg-[#A4C639]/5 transition-all group flex flex-col justify-between"
                    >
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-sm font-bold text-[#111111] group-hover:text-[#607A16] transition-colors">
                          {skill.name}
                        </span>
                        <CheckCircle2 className="w-4 h-4 text-[#607A16]" />
                      </div>
                      <span className="text-[11px] text-[#777777] font-medium">{skill.tag}</span>
                    </div>
                  ))}
                </div>
              </div>

              <div className="mt-8 pt-6 border-t border-black/10 flex items-center justify-between text-xs text-[#555555]">
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-[11px] font-bold text-[#607A16] uppercase tracking-widest">Discipline 02</span>
                      <h3 className="text-xl sm:text-2xl font-display font-extrabold text-[#111111]">
