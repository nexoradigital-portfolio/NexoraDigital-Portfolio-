...
export const Process: React.FC = () => {
  ...
  return (
    <section id="process" className="py-12 md:py-32 bg-white text-[#111111] relative overflow-hidden border-t border-black/5">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3.5 md:gap-6 relative z-10">
            {PROCESS_STEPS.map((step, idx) => (
              <div
                key={step.number}
                className="p-4 sm:p-6 rounded-3xl bg-[#F5F5F5] border border-black/10 hover:border-[#607A16] hover:bg-white hover:shadow-xl transition-all duration-300 group flex flex-col justify-between"
              >
                <div>
                  ...
                  <div className="flex items-center justify-between mb-3 sm:mb-6">
                    ...
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-white border border-black/10 group-hover:border-[#607A16] flex items-center justify-center transition-colors shadow-sm">
                      {stepIcons[idx % stepIcons.length]}
                    </div>
                  </div>

                  <h3 className="text-lg sm:text-xl font-display font-bold text-[#111111] group-hover:text-[#607A16] transition-colors mb-1.5 sm:mb-2">
                    {step.title}
                  </h3>

                  <p className="text-xs font-semibold text-[#607A16] mb-2 sm:mb-3">
                    {step.summary}
                  </p>
                ...
                <div className="mt-4 pt-3 sm:mt-6 sm:pt-4 border-t border-black/5 flex items-center justify-between text-[10px] font-mono text-neutral-500">
